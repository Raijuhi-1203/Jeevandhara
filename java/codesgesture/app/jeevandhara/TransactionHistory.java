...
import codesgesture.app.jeevandhara.Adapter.TransactionAdapter;
...
public class TransactionHistory  extends AppCompatActivity {
    ...
    TransactionAdapter orderAdapter;
    String s;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GridLayoutManager mLayoutManager = new GridLayoutManager(TransactionHistory.this, 1);
        recycler.setLayoutManager(mLayoutManager);
        orderAdapter = new TransactionAdapter(TransactionHistory.this, orders, R.layout.item_transaction);
    ...
    private void GetData() {
        ...
        CallJson jc = new CallJson(TransactionHistory.this);
        param.add(new NetParam("customer_id",executiveModel.getExecutive_id()));
        jc.SendRequest(s,"get_transaction", param, new JsonCallbacks() {
            @Override
            public void onPostSuceess(String json, String method) throws JSONException {
                ...
                for (int s = 0; s < array.length(); s++) {
                    ...
                    product.setPoint_value(obj.getString("point_value"));
                    orders.add(product);
                }
