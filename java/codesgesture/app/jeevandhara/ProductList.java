...
public class ProductList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText("Electronic Appliances");
        ...
        GridLayoutManager mLayoutManager = new GridLayoutManager(ProductList.this, 2);
        rvdeal.setLayoutManager(mLayoutManager);
        productAdapter = new ProductAdapter(ProductList.this, productModels, R.layout.item_product);
    ...
    private void GetDataProduct() {
        ...
        CallJsonWithoutProgress jc = new CallJsonWithoutProgress(ProductList.this);
        jc.SendRequest(s,"getall_product", param, new JsonCallbacks() {
            @Override
