package codesgesture.app.jeevandhara.Utils;
...
{
    public static void SetCustomerSessions(Context context, ExecutiveModel customers) {
        Gson gson = new Gson();
        String json = gson.toJson(customers);
        setSharedPreferenceString(context, "login", json);
    }

    public static ExecutiveModel getCurrentUser(Context context) {
        ExecutiveModel customers=null;
        Gson gson = new Gson();
        String json = getSharedPreferenceString(context, "login", null);
        if (json != null)
            customers = gson.fromJson(json, ExecutiveModel.class);
        return customers;
    }
